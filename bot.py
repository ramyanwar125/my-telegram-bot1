...
# --- Configuration ---
TOKEN = '8387722267:AAExqobzpO-KPUVYnXd6U-eYrieKCP8A7Xg'
OWNER_ID = 7349033289
ADMIN_ID = 7349033289
YOUR_USERNAME = 'TOP_1UP'
UPDATE_CHANNEL = 'https://t.me/T_U_H1'
...
ADMIN_COMMAND_BUTTONS_LAYOUT_USER_SPEC = [
    ...
    ["🔒 Lock Bot"],  # تم إزالة Running All Code
...
# تم تعطيل هذه الدالة لحماية البوت
def _logic_run_all_scripts(message_or_call):
    if isinstance(message_or_call, telebot.types.Message):
        bot.reply_to(message_or_call, "⚠️ هذه الميزة معطلة حالياً لحماية البوت.")
    elif isinstance(message_or_call, telebot.types.CallbackQuery):
        bot.answer_callback_query(message_or_call.id, "⚠️ هذه الميزة معطلة حالياً", show_alert=True)
    return
...
# تم تعطيل الأمر الخاص بتشغيل جميع السكربتات
